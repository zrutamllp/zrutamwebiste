export const SOLUTIONS = [
  {
    ...
    description:
      "AI-adaptive learning paths, scenario simulations, and executive coaching for mid-to-large enterprises.",
    icon: "leadership",
    features: [
  ...
  },
  {
    ...
    shortTitle: "IDP Tool",
    description:
      "White-labeled, LMS-integrated Individual Development Plan tool powered by our proprietary RSI™ Career Driver Assessment.",
    icon: "idp",
    features: [
  ...
  },
  {
    ...
    description:
      "Skills-first approach to internal mobility, competency mapping, and workforce transformation.",
    icon: "upskilling",
    features: [
  ...
  },
  {
    ...
    description:
      "Scenario-based, immersive, APAC-context content with microlearning modules and gamification.",
    icon: "elearning",
    features: [
  ...
  },
  {
    ...
    description:
      "Real-time skill gap identification and analytics that integrates with your existing LMS/HRIS.",
    icon: "assessment",
    features: [
